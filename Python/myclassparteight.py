...
class Participant:
    ...
    def __init__(self, firstname, lastname):
        ...
        #inside methods we can have 2 types of variables,
        #1) Instance variable prefix with word self
        #Instance variable live until the object is destroyed
        #2) Local variable not prefixed with the word self
        #Local variable will die after method execution
